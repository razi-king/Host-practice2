...
import { getEmpById, updateEmp } from '../APIHandling/API';
...
const UpdateEmp = () => {
    ...
    const onSubmit = (e)=>{
        ...
        updateEmp(id,emp).then((res)=>{
            ...
            setMessage("");
            setError("Error Occured While Updating User");
        })
    }
  return (
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <form class="bg-white p-6 rounded-lg shadow-md w-full max-w-md" onSubmit={onSubmit}>
            <table class="w-full">
                <tr>
